...
public class ViewPagerFragmentClosed extends Fragment implements ItemFilter {
  
  private static final String LOG_TAG = ViewPagerFragmentClosed.class.getSimpleName();

  FragmentCustomerDealsBinding b;
  private String mCustomerId;

  public static ViewPagerFragmentClosed newInstance(String customerId) {
    ViewPagerFragmentClosed fragment = new ViewPagerFragmentClosed();
